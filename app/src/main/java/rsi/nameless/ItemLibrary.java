...
public class ItemLibrary implements Serializable{
    ...
    private void addPotions () {
        potions.add( new Potion ("Refreshment potion","Heals minor wounds." , 0, 0, 0, 0, 0, 1, 7, 5, 3, R.drawable.hp_pot1) ); //Name, description str, def, skl, spd, MaxHP, lvl, price, HPRes, nrUses, imgId
    ...
    private void addArmour () {
        ...
        armour.add( new Armour ("Small Shield","Easy to carry but only adds a little to defence." ,0, 2, 0, 0, 0, 1, 3,R.drawable.small_shield));
    }
